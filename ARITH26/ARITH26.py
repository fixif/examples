...
for S in (S2,):
	...
	print("----- " + S.name + " -----")
	print("m_tilde="+str(S._computeNaiveMSB(ubar)))
	print("w_tilde="+str(S._w_tilde(ubar)))
	print("Wmin uniform  = %d" % S.optimalUniformWL(ubar, eps_final))
	print("Wmin equiv" + str(S.optimalWL(ubar, eps_final, S._filter.name + '.dat')))
